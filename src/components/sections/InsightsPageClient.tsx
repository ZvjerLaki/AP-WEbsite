  ...
  return (
    <article className="group flex flex-col bg-white border border-ap-border rounded-2xl overflow-hidden hover:shadow-md transition-all duration-300">
      ...
      <div className="flex flex-col flex-1 p-6">
        {post.publishedAt && (
          <time dateTime={post.publishedAt} className="text-xs font-medium text-ap-light mb-3">
...
export default function InsightsPageClient({ posts }: { posts: SanityPost[] }) {
  ...
  // While searching, always show page 1 of filtered results
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {pagePosts.length > 0 ? (
          ...
          <div className="py-24 text-center">
            <p className="text-ap-mid text-lg">No insights found.</p>
          </div>
        )}
